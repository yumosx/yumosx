...
Currently exploring / contributing to exciting open-source AI tools:

- **[adenhq/hive](https://github.com/adenhq/hive)**  
  Outcome-driven agent development framework that evolves (goal → node graph → self-improvement)

- **[GoogleCloudPlatform/kubectl-ai](https://github.com/GoogleCloudPlatform/kubectl-ai)**  
  AI-powered Kubernetes Assistant

- **[continuedev/continue](https://github.com/continuedev/continue)**  
  Open-source AI code assistant — supports headless async agents & TUI sync mode

Open to **collaboration**, **consulting**, **full-time opportunities**, or **interesting side projects** in:
